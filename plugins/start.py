...
async def not_joined(client: Client, message: Message):
    text ="<b>നിങ്ങൾ ആവിശ്യപ്പെട്ട സിനിമ ലഭിക്കുന്നതായി, നിങ്ങൾ ഞങ്ങളുടെ 'CinemaClub🎥' ചാനലിൽ ജോയിൻ ചെയ്യണം.                                                            ജോയിൻ ചെയ്യാൻ തായേ ഉള്ള ബട്ടൺ അമർത്തുക                                    ജോയിൻ ചെയ്ത ശേഷം ഒന്നും കൂടി ഗ്രൂപ്പിൽ പോയി ഒന്നൂടെ try ചെയ്യുക bro😍</b>"
